...
public:
	...
	// exercise stencil states
	static ID3D11DepthStencilState* Exercise1DSS;
	static ID3D11DepthStencilState* Exercise2DSS;
	static ID3D11DepthStencilState* Exercise3DSS;
};
