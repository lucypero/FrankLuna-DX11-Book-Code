		...
		std::vector<std::wstring>& filenames)
{
	...
	for(UINT i = 0; i < size; ++i)
	{
        ...
        HR(CreateDDSTextureFromFileEx(device, filenames[i].c_str(), 0, D3D11_USAGE_STAGING, 0, D3D11_CPU_ACCESS_WRITE | D3D11_CPU_ACCESS_READ, 0, false, (ID3D11Resource**)&srcTex[i], 0));
	}
